...
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/projects/razam-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file://D:/projects/razam-nuxt/node_modules/destr/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/projects/razam-nuxt/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file://D:/projects/razam-nuxt/node_modules/vue/index.mjs';
import { walkResolver } from 'file://D:/projects/razam-nuxt/node_modules/unhead/dist/utils.mjs';
...
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/projects/razam-nuxt/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://D:/projects/razam-nuxt/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/projects/razam-nuxt/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/projects/razam-nuxt/node_modules/node-mock-http/dist/index.mjs';
...
import { digest } from 'file://D:/projects/razam-nuxt/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/projects/razam-nuxt/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/projects/razam-nuxt/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/projects/razam-nuxt/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/projects/razam-nuxt/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/projects/razam-nuxt/node_modules/nitropack/node_modules/source-map/source-map.js';
...
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/projects/razam-nuxt/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://D:/projects/razam-nuxt/node_modules/pathe/dist/index.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/projects/razam-nuxt","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/projects/razam-nuxt/server","watchOptions":{"ignored":[null]}}));
...
const _NyTGLC5gARpJkN9Ynyg_Nk_JdZXgo8dNjZxLdNOXBE = (nitroApp) => {
...
const plugins = [
  _NyTGLC5gARpJkN9Ynyg_Nk_JdZXgo8dNjZxLdNOXBE
];
...
const _o3G8Bk = lazyEventHandler(() => {
...
const _lazy_vwNeTQ = () => Promise.resolve().then(function () { return blog$1; });
const _lazy_Q7RjbN = () => Promise.resolve().then(function () { return googleReviews$1; });
const _lazy_RZaD1u = () => Promise.resolve().then(function () { return projects$1; });
const _lazy_i4Igm3 = () => Promise.resolve().then(function () { return search; });
const _lazy_zSAdG3 = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/_ipx/**', handler: _o3G8Bk, lazy: false, middleware: false, method: undefined },
...
const blog = defineEventHandler((event) => {
  ...
  if (query.slug) {
    const article = blog$2.find((article2) => article2.slug === query.slug);
...
const googleReviews$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
