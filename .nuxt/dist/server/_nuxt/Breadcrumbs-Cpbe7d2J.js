...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-14fea720><ul data-v-14fea720><!--[-->`);
      ssrRenderList(breadcrumbs.value, (crumb, index) => {
        _push(`<li data-v-14fea720>`);
        if (crumb.to) {
          ...
          _push(`<span data-v-14fea720>${ssrInterpolate(crumb.label)}</span>`);
        }
        _push(`</li>`);
      });
      _push(`<!--]--></ul></nav>`);
...
const Breadcrumbs = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14fea720"]]);
export {
  Breadcrumbs as B
};
//# sourceMappingURL=Breadcrumbs-Cpbe7d2J.js.map
