...
import { ac as useRequestEvent, _ as _export_sfc, ad as useSwitchLocalePath, f as useLocalePath } from "../server.mjs";
import { _ as _imports_0$2 } from "./virtual_public-D98CVXli.js";
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "switcher" }, _attrs))} data-v-e391b30b><div class="current" data-v-e391b30b>${ssrInterpolate(unref(currentLocal).toUpperCase())}</div><div class="${ssrRenderClass([{ open: unref(isOpen) }, "dropdown"])}" data-v-e391b30b><!--[-->`);
...
const LangSwitchComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-e391b30b"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-966c7789><div class="container" data-v-966c7789><div class="logo" data-v-966c7789>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0$2)} alt="Razam" data-v-966c7789${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0$2,
  ...
  _push(`</div><nav class="nav-menu" data-v-966c7789><ul data-v-966c7789><li data-v-966c7789>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: _ctx.localePath("/"),
  ...
  _push(`</li><span class="divider" data-v-966c7789>/</span><li data-v-966c7789>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
...
const HeaderComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-966c7789"]]);
const _imports_0$1 = publicAssetsURL("/logo-white.webp");
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<!--[--><footer class="footer" data-v-ad09d62a><div class="links" data-v-ad09d62a><div class="logo" data-v-ad09d62a><img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-ad09d62a></div><div class="medias" data-v-ad09d62a>`);
...
const FooterComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ad09d62a"]]);
...
//# sourceMappingURL=default-DpG5d6kX.js.map
