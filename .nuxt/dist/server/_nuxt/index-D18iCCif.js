...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</section><section class="offer" data-v-27783081><h2 data-v-27783081>${ssrInterpolate(_ctx.$t("home.offer.h2P1"))}<span class="arrow" data-v-27783081><img${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-27783081></span><br data-v-27783081><div class="decor" data-v-27783081>${ssrInterpolate(_ctx.$t("home.offer.h2P2"))}<br data-v-27783081> ${ssrInterpolate(_ctx.$t("home.offer.h2P3"))} ? </div></h2><p data-v-27783081>${ssrInterpolate(_ctx.$t("home.offer.p"))}</p></section><section class="process" data-v-27783081><div class="container" data-v-27783081><h2 data-v-27783081><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.h2"))}</span></h2><div class="process-grid" data-v-27783081><div class="process-item" data-v-27783081><div class="process-item-count" data-v-27783081>01</div><div class="process-item-title" data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.title1"))}</div><p data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.text1"))}</p></div><div class="process-item" data-v-27783081><div class="process-item-count" data-v-27783081>02</div><div class="process-item-title" data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.title2"))}</div><p data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.text2"))}</p></div><div class="process-item" data-v-27783081><div class="process-item-count" data-v-27783081>03</div><div class="process-item-title" data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.title3"))}</div><p data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.text3"))}</p></div><div class="process-item process-item-moved" data-v-27783081><div class="process-item-count" data-v-27783081>04</div><div class="process-item-title" data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.title4"))}</div><p data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.text4"))}</p></div><div class="process-item process-item-moved-mob" data-v-27783081><div class="process-item-count" data-v-27783081>05</div><div class="process-item-title" data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.title5"))}</div><p data-v-27783081>${ssrInterpolate(_ctx.$t("home.process.text5"))}</p></div></div></div></section><section class="faq" data-v-27783081><h2 data-v-27783081><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-27783081>FAQ</span></h2>`);
...
//# sourceMappingURL=index-D18iCCif.js.map
