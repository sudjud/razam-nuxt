...
import { S as SocialMedias } from "./SocialMedias-BytsL7Eo.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(questions, (item, index2) => {
        _push(`<div class="${ssrRenderClass([{ open: item.open }, "question-item"])}" data-v-7cee5938><div class="question-number-wrapper" data-v-7cee5938><div class="number" data-v-7cee5938>0${ssrInterpolate(index2)}</div><div class="question" data-v-7cee5938><h4 data-v-7cee5938>${ssrInterpolate(_ctx.$t(item.question))}</h4></div><div class="filler" data-v-7cee5938></div><div class="${ssrRenderClass([{ open: item.open }, "arrow-circle"])}" data-v-7cee5938><svg data-name="1-Arrow Up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="25" height="25" data-v-7cee5938><path d="m26.71 10.29-10-10a1 1 0 0 0-1.41 0l-10 10 1.41 1.41L15 3.41V32h2V3.41l8.29 8.29z" data-v-7cee5938></path></svg></div></div><div class="answer-wrapper" style="${ssrRenderStyle(item.open ? null : { display: "none" })}" data-v-7cee5938><p class="answer" data-v-7cee5938>${ssrInterpolate(_ctx.$t(item.answer))}</p></div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><section class="home" data-v-01ea7d4d><div class="container" data-v-01ea7d4d><div class="social-links" data-v-01ea7d4d>`);
      _push(ssrRenderComponent(SocialMedias, null, null, _parent));
      _push(`</div><div class="content" data-v-01ea7d4d><h1 data-v-01ea7d4d><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-sw reveal-visible" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.headline"))}</span></h1></div></div></section><section class="expert-design" data-v-01ea7d4d><div class="container" data-v-01ea7d4d><div class="image-wrapper" data-v-01ea7d4d><img${ssrRenderAttr("src", _imports_0$1)} alt="Interior" data-v-01ea7d4d></div><div class="filler" data-v-01ea7d4d></div><div class="text-content" data-v-01ea7d4d><h3${ssrRenderAttrs(mergeProps({ class: "wow reveal-sb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.desc"))}</h3><p data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.fullDesc1"))}</p><p data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.fullDesc2"))}</p><p class="${ssrRenderClass([{ open: isOpen.value }, "read-more-text"])}" data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.readMore"))}<br data-v-01ea7d4d><br data-v-01ea7d4d> ${ssrInterpolate(_ctx.$t("home.readMore2"))}<br data-v-01ea7d4d><br data-v-01ea7d4d> ${ssrInterpolate(_ctx.$t("home.readMore3"))}</p><span class="read-more" data-v-01ea7d4d>${ssrInterpolate(isOpen.value ? _ctx.$t("common.hide") : _ctx.$t("common.readMore"))}</span></div></div></section><section class="values" data-v-01ea7d4d><div class="container" data-v-01ea7d4d><div class="main" data-v-01ea7d4d><div class="title-block" data-v-01ea7d4d><h2 data-v-01ea7d4d><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>${_ctx.$t("home.valuesH2") ?? ""}</span></h2><div class="arrow-down" data-v-01ea7d4d><span data-v-01ea7d4d>↓</span></div></div><div class="image-wrapper" data-v-01ea7d4d><img${ssrRenderAttr("src", _imports_1)} alt="Интерьер" data-v-01ea7d4d></div></div>`);
      ...
      _push(`<section class="services" data-v-01ea7d4d>`);
      _push(ssrRenderComponent(HomeGallery, null, null, _parent));
      _push(`</section><section class="projects" data-v-01ea7d4d><div class="projects-container" data-v-01ea7d4d><h3 data-v-01ea7d4d><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.projectsH2"))}</span></h3>`);
      _push(ssrRenderComponent(ProjectsSwiperComponent, null, null, _parent));
      _push(`</div></section><section class="reviews" data-v-01ea7d4d><h2 data-v-01ea7d4d><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.reviewsH2P1"))}<br data-v-01ea7d4d> ${ssrInterpolate(_ctx.$t("home.reviewsH2P2"))}</span></h2><div class="divider" data-v-01ea7d4d></div>`);
      ...
      _push(`<section class="process" data-v-01ea7d4d><div class="container" data-v-01ea7d4d><h2 data-v-01ea7d4d><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.h2"))}</span></h2><div class="process-grid" data-v-01ea7d4d><div class="process-item" data-v-01ea7d4d><div class="process-item-count" data-v-01ea7d4d>01</div><div class="process-item-title" data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.title1"))}</div><p data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.text1"))}</p></div><div class="process-item" data-v-01ea7d4d><div class="process-item-count" data-v-01ea7d4d>02</div><div class="process-item-title" data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.title2"))}</div><p data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.text2"))}</p></div><div class="process-item" data-v-01ea7d4d><div class="process-item-count" data-v-01ea7d4d>03</div><div class="process-item-title" data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.title3"))}</div><p data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.text3"))}</p></div><div class="process-item process-item-moved" data-v-01ea7d4d><div class="process-item-count" data-v-01ea7d4d>04</div><div class="process-item-title" data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.title4"))}</div><p data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.text4"))}</p></div><div class="process-item process-item-moved-mob" data-v-01ea7d4d><div class="process-item-count" data-v-01ea7d4d>05</div><div class="process-item-title" data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.title5"))}</div><p data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.process.text5"))}</p></div></div></div></section><section class="faq" data-v-01ea7d4d><h2 data-v-01ea7d4d><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>FAQ</span></h2>`);
      _push(ssrRenderComponent(FaqComponent, null, null, _parent));
      _push(`</section><section class="news" data-v-01ea7d4d><h2 data-v-01ea7d4d><span${ssrRenderAttrs(mergeProps({ class: "wow reveal-bb" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-01ea7d4d>${ssrInterpolate(_ctx.$t("home.news.H2"))}</span></h2>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-01ea7d4d"]]);
export {
  index as default
};
//# sourceMappingURL=index-CLck8pyd.js.map
