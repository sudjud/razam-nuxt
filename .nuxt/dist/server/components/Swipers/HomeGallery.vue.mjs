...
import photo2 from "../../public/images/services/interior-design/1gallery.webp.mjs";
import photo3 from "../../public/images/services/interior-design/2gallery.webp.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(items, (item, index) => {
        ...
        if (index === currentIndex.value) {
          _push(`<div class="arrow-wrapper" data-v-f9004d45><div class="arrow" data-v-f9004d45><img${ssrRenderAttr("src", _imports_0$3)} alt="arrow" data-v-f9004d45></div></div>`);
        } else {
          _push(`<!---->`);
        }
