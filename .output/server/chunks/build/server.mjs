import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, unref, ref, computed, defineComponent, h, Fragment, createVNode, Text, defineAsyncComponent, Suspense, nextTick, mergeProps, provide, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { i as createHooks, k as getContext, c as createError$1, t as toRouteMatcher, l as createRouter, m as defu, s as sanitizeStatusCode, n as executeAsync, o as getRequestHeaders, p as getRequestHeader, q as getRequestProtocol, r as destr, v as klona, w as isEqual$1, x as setCookie, y as getCookie, z as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  ...
  {
    name: "portfolio-slug___fr",
    path: "/portfolio/:slug()",
    component: () => import('./_slug_.vue.mjs')
  },
  {
    name: "portfolio-slug___ru",
    path: "/ru/portfolio/:slug()",
    component: () => import('./_slug_.vue.mjs')
  },
  {
    name: "services-interiordesign___en",
    path: "/en/services/interiordesign",
    component: () => import('./interiordesign.vue.mjs')
  },
  {
    name: "services-interiordesign___fr",
    path: "/services/interiordesign",
    component: () => import('./interiordesign.vue.mjs')
  },
  {
    name: "services-interiordesign___ru",
    path: "/ru/services/interiordesign",
    component: () => import('./interiordesign.vue.mjs')
  },
  {
    name: "services-houserenovation___en",
    path: "/en/services/houserenovation",
    component: () => import('./houserenovation.vue.mjs')
  },
  {
    name: "services-houserenovation___fr",
    path: "/services/houserenovation",
    component: () => import('./houserenovation.vue.mjs')
  },
  {
    name: "services-houserenovation___ru",
    path: "/ru/services/houserenovation",
    component: () => import('./houserenovation.vue.mjs')
  },
  {
    name: "services-commercerenovation___en",
    path: "/en/services/commercerenovation",
    component: () => import('./commercerenovation.vue.mjs')
  },
  {
    name: "services-commercerenovation___fr",
    path: "/services/commercerenovation",
    component: () => import('./commercerenovation.vue.mjs')
  },
  {
    name: "services-commercerenovation___ru",
    path: "/ru/services/commercerenovation",
    component: () => import('./commercerenovation.vue.mjs')
  }
];
...
const plugins = [
  ...
  reveal_2W0DU7K6hPNm6nNUmZ_FGMD2jdXBTITvuoGpq4eyUBw,
...
export { registerMessageCompiler as $, isRegExp as A, isFunction as B, updateFallbackLocale as C, DEFAULT_LOCALE as D, deepCopy as E, hasOwn as F, createCoreContext as G, clearDateTimeFormat as H, clearNumberFormat as I, isMessageAST as J, AST_NODE_PROPS_KEYS as K, setAdditionalMeta as L, getFallbackContext as M, isNumber as N, NOT_REOSLVED as O, fallbackWithLocaleChain as P, setFallbackContext as Q, CORE_ERROR_CODES_EXTEND_POINT as R, parseTranslateArgs as S, translate as T, MISSING_RESOLVE_VALUE as U, parseDateTimeArgs as V, datetime as W, parseNumberArgs as X, number as Y, isMessageFunction as Z, _export_sfc as _, useRoute as a, registerMessageResolver as a0, registerLocaleFallbacker as a1, NUMBER_FORMAT_OPTIONS_KEYS as a2, DATETIME_FORMAT_OPTIONS_KEYS as a3, compile as a4, resolveValue as a5, useSwitchLocalePath as a6, server as a7, useNuxtApp as b, asyncDataDefaults as c, createError as d, useRouter as e, useRuntimeConfig as f, withoutTrailingSlash as g, hasProtocol as h, nuxtLinkDefaults as i, joinURL as j, assign as k, createCompileError as l, makeSymbol as m, navigateTo as n, isEmptyObject as o, parseQuery as p, isObject as q, resolveRouteObject$1 as r, create as s, tryUseNuxtApp as t, useLocalePath as u, isBoolean as v, withTrailingSlash as w, isString as x, isArray as y, isPlainObject as z };
