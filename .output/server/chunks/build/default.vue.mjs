...
import { _ as _export_sfc, a6 as useSwitchLocalePath, u as useLocalePath, f as useRuntimeConfig } from './server.mjs';
import { _ as _imports_0$2 } from './virtual_public26.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0$2)} alt="Razam" data-v-90449e12${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0$2,
...
const HeaderComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-90449e12"]]);
